...
import { login } from '../../services/api/usuarios'; // ← Esta es la ruta correcta
...
function AdminLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Verificar si es admin - ajusta esta lógica según tu API
            if (usuario && (usuario.role === 'ADMIN' || usuario.esAdmin)) {
